...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-emojione/node_modules/emojione/lib/js/emojione.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-emojione">npmtest-emojione (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-emojione/node_modules/emojione/lib/js/emojione.js</span></h1>
    <h2>
        
        Statements: <span class="metric">22.17% <small>(45 / 203)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">5.61% <small>(6 / 107)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">3.23% <small>(1 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">22.45% <small>(44 / 196)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-emojione/node_modules/emojione/lib/js/</a> &#187; emojione.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2427</span>
<span class="cline-any cline-yes">2427</span>
<span class="cline-any cline-yes">2427</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* jshint maxerr: 10000 */
/* jslint unused: true */
/* jshint shadow: true */
/* jshint -W075 */
(function(ns){
...
&nbsp;
   var tmpShortNames = [], emoji;
    for (emoji in ns.emojioneList) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!ns.emojioneList.hasOwnProperty(emoji) || (emoji === '')) <span class="cstat-no" title="statement not covered" >continue;</span>
...
&nbsp;
	...
	ns.emojiSize = '64';
	ns.greedyMatch = false; // set to true for greedy matching
...
&nbsp;
    ...
    ns.toImage = <span class="fstat-no" title="function not covered" >function(str) {</span>
<span class="cstat-no" title="statement not covered" >        str = ns.unicodeToImage(str);</span>
<span class="cstat-no" title="statement not covered" >        str = ns.shortnameToImage(str);</span>
...
&nbsp;
    ...
    ns.unifyUnicode = <span class="fstat-no" title="function not covered" >function(str) {</span>
<span class="cstat-no" title="statement not covered" >        str = ns.toShort(str);</span>
<span class="cstat-no" title="statement not covered" >        str = ns.shortnameToUnicode(str);</span>
<span class="cstat-no" title="statement not covered" >        return str;</span>
    };
&nbsp;
    // Replace shortnames (:wink:) with Ascii equivalents ( ;^) )
    // Useful for systems that dont support unicode nor images
    ns.shortnameToAscii = <span class="fstat-no" title="function not covered" >function(str) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        str = str.replace(ns.regShortNames, <span class="fstat-no" title="function not covered" >function(shortname) {</span></span>
<span class="cstat-no" title="statement not covered" >            if( (typeof shortname === 'undefined') || (shortname === '') || (!(shortname in ns.emojioneList)) ) {</span>
                // if the shortname doesnt exist just return the entire match
<span class="cstat-no" title="statement not covered" >                return shortname;</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                unicode = ns.emojioneList[shortname].uc_output;</span>
<span class="cstat-no" title="statement not covered" >                if(typeof unicodeToAscii[unicode] !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >                    return unicodeToAscii[unicode];</span>
                } else {
<span class="cstat-no" title="statement not covered" >                    return shortname;</span>
                }
            }
...
&nbsp;
    ...
    ns.shortnameToUnicode = <span class="fstat-no" title="function not covered" >function(str) {</span>
        // replace regular shortnames first
<span class="cstat-no" title="statement not covered" >        var unicode,fname;</span>
<span class="cstat-no" title="statement not covered" >        str = str.replace(ns.regShortNames, <span class="fstat-no" title="function not covered" >function(shortname) {</span></span>
<span class="cstat-no" title="statement not covered" >            if( (typeof shortname === 'undefined') || (shortname === '') || (!(shortname in ns.emojioneList)) ) {</span>
                // if the shortname doesnt exist just return the entire matchhju
<span class="cstat-no" title="statement not covered" >                return shortname;</span>
            }
<span class="cstat-no" title="statement not covered" >            unicode = ns.emojioneList[shortname].uc_output.toUpperCase();</span>
<span class="cstat-no" title="statement not covered" >            fname = ns.emojioneList[shortname].uc_base;</span>
<span class="cstat-no" title="statement not covered" >            return ns.convert(unicode);</span>
        });
&nbsp;
        // if ascii smileys are turned on, then we'll replace them!
<span class="cstat-no" title="statement not covered" >        if (ns.ascii) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            str = str.replace(ns.regAscii, <span class="fstat-no" title="function not covered" >function(entire, m1, m2, m3) {</span></span>
<span class="cstat-no" title="statement not covered" >                if( (typeof m3 === 'undefined') || (m3 === '') || (!(ns.unescapeHTML(m3) in ns.asciiList)) ) {</span>
                    // if the shortname doesnt exist just return the entire match
<span class="cstat-no" title="statement not covered" >                    return entire;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                m3 = ns.unescapeHTML(m3);</span>
<span class="cstat-no" title="statement not covered" >                unicode = ns.asciiList[m3].toUpperCase();</span>
<span class="cstat-no" title="statement not covered" >                return m2+ns.convert(unicode);</span>
            });
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return str;</span>
...
&nbsp;
    ns.shortnameToImage = <span class="fstat-no" title="function not covered" >function(str) {</span>
        // replace regular shortnames first
<span class="cstat-no" title="statement not covered" >        var replaceWith,shortname,unicode,fname,alt,category,title;</span>
<span class="cstat-no" title="statement not covered" >		var mappedUnicode = ns.mapUnicodeToShort();</span>
<span class="cstat-no" title="statement not covered" >        str = str.replace(ns.regShortNames, <span class="fstat-no" title="function not covered" >function(shortname) {</span></span>
<span class="cstat-no" title="statement not covered" >            if( (typeof shortname === 'undefined') || (shortname === '') || (ns.shortnames.indexOf(shortname) === -1) ) {</span>
                // if the shortname doesnt exist just return the entire match
<span class="cstat-no" title="statement not covered" >                return shortname;</span>
            }
            else {
				// map shortname to parent
<span class="cstat-no" title="statement not covered" >				if (!ns.emojioneList[shortname]) {</span>
<span class="cstat-no" title="statement not covered" >					for ( var emoji in ns.emojioneList ) {</span>
<span class="cstat-no" title="statement not covered" >						if (!ns.emojioneList.hasOwnProperty(emoji) || (emoji === '')) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >						if (ns.emojioneList[emoji].shortnames.indexOf(shortname) === -1) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >						shortname = emoji;</span>
<span class="cstat-no" title="statement not covered" >						break;</span>
					}
				}
<span class="cstat-no" title="statement not covered" >                unicode = ns.emojioneList[shortname].uc_output;</span>
<span class="cstat-no" title="statement not covered" >				fname = ns.emojioneList[shortname].uc_base;</span>
<span class="cstat-no" title="statement not covered" >				category = ns.emojioneList[shortname].category;</span>
<span class="cstat-no" title="statement not covered" >                title = ns.imageTitleTag ? 'title="' + shortname + '"' : '';</span>
&nbsp;
                // depending on the settings, we'll either add the native unicode as the alt tag, otherwise the shortname
<span class="cstat-no" title="statement not covered" >                alt = (ns.unicodeAlt) ? ns.convert(unicode.toUpperCase()) : shortname;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if(ns.sprites) {</span>
<span class="cstat-no" title="statement not covered" >                    replaceWith = '&lt;span class="emojione emojione-32-' + category + ' _' + unicode + '" ' + title + '&gt;' + alt + '&lt;/span&gt;';</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    replaceWith = '&lt;img class="emojione" alt="' + alt + '" ' + title + ' src="' + ns.imagePathPNG + '' + fname + '.png"/&gt;';</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                return replaceWith;</span>
            }
        });
&nbsp;
        // if ascii smileys are turned on, then we'll replace them!
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                m3 = ns.unescapeHTML(m3);</span>
<span class="cstat-no" title="statement not covered" >                unicode = ns.asciiList[m3];</span>
<span class="cstat-no" title="statement not covered" >				shortname = mappedUnicode[unicode];</span>
<span class="cstat-no" title="statement not covered" >				category = ns.emojioneList[shortname].category;</span>
<span class="cstat-no" title="statement not covered" >                title = ns.imageTitleTag ? 'title="' + ns.escapeHTML(m3) + '"' : '';</span>
&nbsp;
                // depending on the settings, we'll either add the native unicode as the alt tag, otherwise the shortname
<span class="cstat-no" title="statement not covered" >                alt = (ns.unicodeAlt) ? ns.convert(unicode.toUpperCase()) : ns.escapeHTML(m3);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if(ns.sprites) {</span>
<span class="cstat-no" title="statement not covered" >                    replaceWith = m2+'&lt;span class="emojione emojione-32-' + category + ' _' + unicode +'"  ' + title + '&gt;' + alt + '&lt;/span&gt;';</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    replaceWith = m2+'&lt;img class="emojione" alt="'+alt+'" ' + title + ' src="' + ns.imagePathPNG + unicode + '.png"/&gt;';</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                return replaceWith;</span>
            });
...
&nbsp;
    ns.unicodeToImage = <span class="fstat-no" title="function not covered" >function(str) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var replaceWith,unicode,short,fname,alt,category,title;</span>
<span class="cstat-no" title="statement not covered" >        var mappedUnicode = ns.mapUnicodeToShort();</span>
<span class="cstat-no" title="statement not covered" >		var eList = ns.emojioneList;</span>
<span class="cstat-no" title="statement not covered" >        str = str.replace(ns.regUnicode, <span class="fstat-no" title="function not covered" >function(unicodeChar) {</span></span>
<span class="cstat-no" title="statement not covered" >			if( (typeof unicodeChar === 'undefined') || (unicodeChar === '') )</span>
			{
<span class="cstat-no" title="statement not covered" >				return unicodeChar;</span>
			}
			else <span class="cstat-no" title="statement not covered" >if ( unicodeChar in ns.jsEscapeMap )</span>
			{
<span class="cstat-no" title="statement not covered" >				fname = ns.jsEscapeMap[unicodeChar];</span>
			}
			else <span class="cstat-no" title="statement not covered" >if ( ns.greedyMatch &amp;&amp; ( unicodeChar in ns.jsEscapeMapGreedy ) )</span>
			{
<span class="cstat-no" title="statement not covered" >				fname = ns.jsEscapeMapGreedy[unicodeChar];</span>
			}
			else
			{
<span class="cstat-no" title="statement not covered" >				return unicodeChar;</span>
...
<span class="cstat-no" title="statement not covered" >			short = mappedUnicode[fname];</span>
			
			// then pull the unicode output from emojioneList
<span class="cstat-no" title="statement not covered" >			unicode = eList[short].uc_output;</span>
<span class="cstat-no" title="statement not covered" >			category = eList[short].category;</span>
&nbsp;
			// depending on the settings, we'll either add the native unicode as the alt tag, otherwise the shortname
<span class="cstat-no" title="statement not covered" >			alt = (ns.unicodeAlt) ? ns.convert(unicode.toUpperCase()) : short;</span>
<span class="cstat-no" title="statement not covered" >			title = ns.imageTitleTag ? 'title="' + short + '"' : '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >			if(ns.sprites) {</span>
<span class="cstat-no" title="statement not covered" >				replaceWith = '&lt;span class="emojione emojione-32-' + category + ' _' + unicode + '" ' + title + '&gt;' + alt + '&lt;/span&gt;';</span>
			}
...
&nbsp;
    ...
    ns.toShort = <span class="fstat-no" title="function not covered" >function(str) {</span>
<span class="cstat-no" title="statement not covered" >        var find = ns.unicodeCharRegex();</span>
<span class="cstat-no" title="statement not covered" >        return  ns.replaceAll(str, find);</span>
    };
&nbsp;
    // for converting unicode code points and code pairs to their respective characters
    ns.convert = <span class="fstat-no" title="function not covered" >function(unicode) {</span>
<span class="cstat-no" title="statement not covered" >        if(unicode.indexOf("-") &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >            var parts = [];</span>
<span class="cstat-no" title="statement not covered" >            var s = unicode.split('-');</span>
<span class="cstat-no" title="statement not covered" >            for(var i = 0; i &lt; s.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >                var part = parseInt(s[i], 16);</span>
<span class="cstat-no" title="statement not covered" >                if (part &gt;= 0x10000 &amp;&amp; part &lt;= 0x10FFFF) {</span>
<span class="cstat-no" title="statement not covered" >                    var hi = Math.floor((part - 0x10000) / 0x400) + 0xD800;</span>
<span class="cstat-no" title="statement not covered" >                    var lo = ((part - 0x10000) % 0x400) + 0xDC00;</span>
<span class="cstat-no" title="statement not covered" >                    part = (String.fromCharCode(hi) + String.fromCharCode(lo));</span>
                }
                else {
<span class="cstat-no" title="statement not covered" >                    part = String.fromCharCode(part);</span>
                }
...
<span class="cstat-no" title="statement not covered" >            var s = parseInt(unicode, 16);</span>
<span class="cstat-no" title="statement not covered" >            if (s &gt;= 0x10000 &amp;&amp; s &lt;= 0x10FFFF) {</span>
<span class="cstat-no" title="statement not covered" >                var hi = Math.floor((s - 0x10000) / 0x400) + 0xD800;</span>
<span class="cstat-no" title="statement not covered" >                var lo = ((s - 0x10000) % 0x400) + 0xDC00;</span>
<span class="cstat-no" title="statement not covered" >                return (String.fromCharCode(hi) + String.fromCharCode(lo));</span>
            }
            else {
<span class="cstat-no" title="statement not covered" >                return String.fromCharCode(s);</span>
            }
        }
    };
&nbsp;
    ns.escapeHTML = <span class="fstat-no" title="function not covered" >function (string) {</span>
...
<span class="cstat-no" title="statement not covered" >            return escaped[match];</span>
        });
    };
    ns.unescapeHTML = <span class="fstat-no" title="function not covered" >function (string) {</span>
<span class="cstat-no" title="statement not covered" >        var unescaped = {</span>
            '&amp;amp;'  : '&amp;',
            '&amp;#38;'  : '&amp;',
            '&amp;#x26;' : '&amp;',
            '&amp;lt;'   : '&lt;',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        return string.replace(/&amp;(?:amp|#38|#x26|lt|#60|#x3C|gt|#62|#x3E|apos|#39|#x27|quot|#34|#x22);/ig, <span class="fstat-no" title="function not covered" >function (match) {</span></span>
<span class="cstat-no" title="statement not covered" >            return unescaped[match];</span>
        });
    };
	
	ns.shortnameConversionMap = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		var map = [], emoji;</span>
<span class="cstat-no" title="statement not covered" >		for (emoji in ns.emojioneList) {</span>
<span class="cstat-no" title="statement not covered" >			if (!ns.emojioneList.hasOwnProperty(emoji) || (emoji === '')) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >			map[ns.convert(ns.emojioneList[emoji].uc_output)] = emoji;</span>
		}
<span class="cstat-no" title="statement not covered" >		return map;</span>
	};
	
	ns.unicodeCharRegex = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >		var map = [];</span>
<span class="cstat-no" title="statement not covered" >		for (emoji in ns.emojioneList) {</span>
<span class="cstat-no" title="statement not covered" >			if (!ns.emojioneList.hasOwnProperty(emoji) || (emoji === '')) <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >			map.push(ns.convert(ns.emojioneList[emoji].uc_output));</span>
		}
<span class="cstat-no" title="statement not covered" >		return map.join('|');</span>
	};
&nbsp;
    ns.mapEmojioneList = <span class="fstat-no" title="function not covered" >function (addToMapStorage) {</span>
<span class="cstat-no" title="statement not covered" >        for (var shortname in ns.emojioneList) {</span>
<span class="cstat-no" title="statement not covered" >            if (!ns.emojioneList.hasOwnProperty(shortname)) { <span class="cstat-no" title="statement not covered" >continue; </span>}</span>
<span class="cstat-no" title="statement not covered" >            var unicode = ns.emojioneList[shortname].uc_base;</span>
<span class="cstat-no" title="statement not covered" >            addToMapStorage(unicode, shortname);</span>
        }
    };
&nbsp;
    ns.mapUnicodeToShort = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >        if (!ns.memMapShortToUnicode) {</span>
<span class="cstat-no" title="statement not covered" >            ns.memMapShortToUnicode = {};</span>
<span class="cstat-no" title="statement not covered" >            ns.mapEmojioneList(<span class="fstat-no" title="function not covered" >function (unicode, shortname) {</span></span>
<span class="cstat-no" title="statement not covered" >                ns.memMapShortToUnicode[unicode] = shortname;</span>
            });
        }
<span class="cstat-no" title="statement not covered" >        return ns.memMapShortToUnicode;</span>
    };
&nbsp;
    ns.memorizeReplacement = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >        if (!ns.unicodeReplacementRegEx || !ns.memMapShortToUnicodeCharacters) {</span>
<span class="cstat-no" title="statement not covered" >            var unicodeList = [];</span>
<span class="cstat-no" title="statement not covered" >            ns.memMapShortToUnicodeCharacters = {};</span>
<span class="cstat-no" title="statement not covered" >            ns.mapEmojioneList(<span class="fstat-no" title="function not covered" >function (unicode, shortname) {</span></span>
<span class="cstat-no" title="statement not covered" >                var emojiCharacter = ns.convert(unicode);</span>
<span class="cstat-no" title="statement not covered" >                ns.memMapShortToUnicodeCharacters[emojiCharacter] = shortname;</span>
<span class="cstat-no" title="statement not covered" >                unicodeList.push(emojiCharacter);</span>
            });
<span class="cstat-no" title="statement not covered" >            ns.unicodeReplacementRegEx = unicodeList.join('|');</span>
        }
    };
&nbsp;
    ns.mapUnicodeCharactersToShort = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >        ns.memorizeReplacement();</span>
<span class="cstat-no" title="statement not covered" >        return ns.memMapShortToUnicodeCharacters;</span>
    };
&nbsp;
    //reverse an object
    ns.objectFlip = <span class="fstat-no" title="function not covered" >function (obj) {</span>
<span class="cstat-no" title="statement not covered" >        var key, tmp_obj = {};</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                tmp_obj[obj[key]] = key;</span>
            }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        return tmp_obj;</span>
    };
&nbsp;
    ns.escapeRegExp = <span class="fstat-no" title="function not covered" >function(string) {</span>
<span class="cstat-no" title="statement not covered" >        return string.replace(/[-[\]{}()*+?.,;:&amp;\\^$#\s]/g, "\\$&amp;");</span>
    };
&nbsp;
    ns.replaceAll = <span class="fstat-no" title="function not covered" >function(string, find) {</span>
<span class="cstat-no" title="statement not covered" >        var escapedFind = ns.escapeRegExp(find); </span>//sorted largest output to smallest output
<span class="cstat-no" title="statement not covered" >        var search = new RegExp("&lt;object[^&gt;]*&gt;.*?&lt;\/object&gt;|&lt;span[^&gt;]*&gt;.*?&lt;\/span&gt;|&lt;(?:object|embed|svg|img|div|span|p|a)[^&gt;]*&gt;|("+escapedFind+")", "gi");</span>
&nbsp;
        // callback prevents replacing anything inside of these common html tags as well as between an &lt;object&gt;&lt;/object&gt; tag
		
<span class="cstat-no" title="statement not covered" >		var replace = <span class="fstat-no" title="function not covered" >function(entire, m1) {</span></span>
<span class="cstat-no" title="statement not covered" >			return ((typeof m1 === 'undefined') || (m1 === '')) ? entire : ns.shortnameConversionMap()[m1];</span>
        };
&nbsp;
<span class="cstat-no" title="statement not covered" >        return string.replace(search,replace);</span>
    };
&nbsp;
}(this.emojione = this.emojione || {}));
<span class="missing-if-branch" title="else path not taken" >E</span>if(typeof module === "object") module.exports = this.emojione;
&nbsp;</pre></td></tr>
</table></pre>
</div>
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 25 2017 18:46:05 GMT+0000 (UTC)</div>
</div>
</body>
</html>
